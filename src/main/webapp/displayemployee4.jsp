...
<body>
	...
	<div class="container">
      ...
      %>
		...
		<div class="alert alert-danger" role="alert">Update failed.
	...
	<div class="container">
		<div class="card mt-3">
			<img class="card-img-top m-4" style="max-width: 70px;"
				src="css/emp.png" alt="Employee image">
			<div class="card-body">
				<h5 class="card-text">
					Emp ID:
					<%= emp.getEid() %></h5>
				...
				<p class="card-text">
					Email:
					<%= emp.getEmail() %></p>
				<a href="UpdateEmployee.jsp?eid=<%= emp.getEid() %>"
					class="icon-btn"><i class="fas fa-edit"></i></a>
