...
<nav class="navbar navbar-expand-lg navbar-light navbarbackground">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="displayemployee2.jsp">Display All</a>
            </li>
             <li class="nav-item">
                <a class="nav-link" href="approval.jsp">Approval status</a>
            </li>
             <li class="nav-item">
                <a class="nav-link" href="status.jsp">Status Table</a>
            </li>
        </ul>
